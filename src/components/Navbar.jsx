  ...
  return (
    <div className={shadow ? 'fixed w-full h-20 shadow-xl z-[100]' : 'fixed w-full h-20 z-[100]'}>
      ...
      <div className={nav ? 'md:hidden fixed left-0 top-0 w-full h-screen bg-black/70' : ''}>
        <div className={
            nav
              ? 'fixed left-0 top-0 w-[75%] sm:w-[60%] md:w-[45%] h-screen bg-[#225c60] p-10 ease-in duration-500'
          ...
          <div>
            <div className='flex w-full items-center justify-between'>
              ...
              <div onClick={handleNav} className='rounded-full shadow-lg shadow-gray-400 p-3 cursor-pointer'>
                <AiOutlineClose size={25} color='#8FD2D6'/>
              </div>
            </div>
            <div className='border-b border-gray-300 my-4'>
              <p className='w-[85%] md:w-[90%] py-4  text-[#8FD2D6]'>Tire suas dúvidas!</p>
            </div>
          </div>
          <div className='py-4 flex flex-col'>
            <ul className='uppercase  text-[#8FD2D6]'>
              <Link href='/' legacyBehavior>
            ...
            <div className='pt-10'>
              <p className='uppercase tracking-widest text-[#8FD2D6]'>Rede sociais</p>
              <div className='flex items-center justify-between my-4 w-full sm:w-[80%]  text-[#8FD2D6]'>
